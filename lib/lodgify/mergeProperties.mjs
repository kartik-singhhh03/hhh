...
export function mergeLodgifyProperty(item) {
  ...
  return {
    ...
    badge: staticAssets?.badge || deriveBadge(item, staticAssets),
    badgeDisplay: staticAssets?.badgeDisplay || null,
    displayArea: staticAssets?.displayArea || null,
    displayResidence: staticAssets?.displayResidence || null,
    displayTitleLine1: staticAssets?.displayTitleLine1 || null,
    displayTitleLine2: staticAssets?.displayTitleLine2 || null,
